...
# Override this in settings_local.py to point to your local DB
# heroku will magically fix this for itself with proper values
DATABASES = {
    'default': {
...
if os.environ.has_key('PB_SECRET_KEY'):
	SECRET_KEY = os.environ['PB_SECRET_KEY']
...
# Override with anything in settings_local
try:
